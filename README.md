...
## ให้ AI พาทำใน Cowork

ถ้านักเรียนใช้ **Claude Cowork** อยู่แล้ว ให้เปิด **`COWORK-START.md`** อ่านวิธีลากไฟล์เข้า Cowork
แล้ว AI จะถาม-ตอบและพาติดตั้งทีละขั้นจนเสร็จ
